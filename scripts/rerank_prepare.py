...
from transquest.algo.sentence_level.monotransquest.run_model import MonoTransQuestModel, MonoTransQuestArgs
...
def main():
    ...
    if args.add_cometsrc is not None:
        ...
        comet_scores, _ = comet_model.predict(
            comet_input, num_workers=4, batch_size=COMETSRC_BATCH_SIZE, sort_by_mtlen=True
        )
